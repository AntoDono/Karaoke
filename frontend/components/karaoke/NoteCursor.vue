<template>
  <div class="absolute inset-0 pointer-events-none z-10">
    <Transition name="note-badge">
      ...
      >
        <span class="font-mono text-lg font-semibold leading-none tracking-tight">{{ activeNote.event.note }}</span>
        <span class="font-mono text-[0.6rem] text-green-200 tracking-wide opacity-70">MIDI {{ activeNote.event.midi }}</span>
